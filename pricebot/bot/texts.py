...
CATALOG_NEED_HTTPS = (
    "Мини-приложение открывается только по HTTPS. "
    "Сейчас укажите публичный https-адрес в WEBAPP_URL "
    "или ищите товары текстом в этом чате."
)
...
IMPORT_ALREADY = "Этот файл уже загружался. Пришлите другой .xlsx или тот же после ошибки."
